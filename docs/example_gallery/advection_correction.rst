...
.. "example_gallery/advection_correction.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_example_gallery_advection_correction.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_example_gallery_advection_correction.py:
...
.. image-sg:: /example_gallery/images/sphx_glr_advection_correction_001.png
   :alt: 3-h rainfall accumulation, mm/h, Same with advection correction, mm/h
   :srcset: /example_gallery/images/sphx_glr_advection_correction_001.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  10.842 seconds)


.. _sphx_glr_download_example_gallery_advection_correction.py:
