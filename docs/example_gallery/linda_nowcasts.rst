...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Detecting features... found 15 blobs in 0.75 seconds.
    Transforming to Lagrangian coordinates... 0.08 seconds.
    Estimating the first convolution kernel... 8.41 seconds.
    Estimating the ARI(p,1) parameters... 0.14 seconds.
    Estimating the second convolution kernel... 7.57 seconds.
    Computing nowcast for time step 1... 0.36 seconds.
    Computing nowcast for time step 2... 0.38 seconds.
    Computing nowcast for time step 3... 0.38 seconds.
    Computing nowcast for time step 4... 0.38 seconds.
    Computing nowcast for time step 5... 0.38 seconds.
    Computing nowcast for time step 6... 0.38 seconds.
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Estimating the first convolution kernel... 8.11 seconds.
    Estimating the ARI(p,1) parameters... 0.14 seconds.
    Estimating the second convolution kernel... 7.30 seconds.
    Estimating forecast errors... 0.55 seconds.
    Estimating perturbation parameters... 36.43 seconds.
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 3 minutes  15.363 seconds)
